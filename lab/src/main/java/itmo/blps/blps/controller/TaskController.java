...
public class TaskController {
    ...
    public ResponseEntity<TaskDTO> getTask(
            @Parameter(description = "ID задания") @PathVariable Long taskId) throws TaskOperationException {
    ...
    public ResponseEntity<List<TaskSubmissionResponseDTO>> getSubmissions(
            ...
            @Parameter(description = "ID студента") @RequestParam Long userId) throws TaskOperationException {
